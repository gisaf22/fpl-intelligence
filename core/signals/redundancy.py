"""Redundancy detection utilities for EDA-6.
...
Algebraic decompositions (e.g. xgi = xg + xa) are definitionally redundant
by construction — not by statistical coincidence — and are tracked separately
in ALGEBRAIC_DECOMPOSITIONS.
"""
...
# Known algebraic decompositions: signal = sum of components.
# Each tuple is (derived_signal, component_a, component_b).
# These pairs are definitionally redundant and must be flagged separately
# from statistically redundant pairs.
