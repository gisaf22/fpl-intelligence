"""Fact layer contracts — column definitions, dtypes, null rules, and aggregation strategies."""
...
# SGW: value unchanged (mean of one). DGW: mean of two fixtures = per-fixture average.
# This makes DGW values directly comparable to SGW values without consumer normalization.
# BGW: NULL (no fixture — handled by PERFORMANCE_COLS rule in _apply_bgw_defaults).
MEAN_COLS = [
    "influence",
    "creativity",
    "threat",
...
DTYPES: dict[str, str] = {
    ...
    "ict_index": "Float64",  # nullable: BGW; per-fixture mean for DGW
    "transfers_out": "int64",
