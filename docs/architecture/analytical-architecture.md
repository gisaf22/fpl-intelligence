...
| **Analysis** | A pre-registered test of a feature against a target | per study | [adlc.md](adlc.md), `studies/*/LENS_DESIGN.md`, [EVAL_DESIGN.md](../../signals/governance/EVAL_DESIGN.md) | Design-locked before code |
