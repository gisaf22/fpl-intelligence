...
- `studies/lenses/avail/LENS_DESIGN.md` — FPL appearance rule explained in a study design document
...
Carries a study reference: `studies/experiments/population_threshold_study.py` (to be written — see Change 3).
...
`studies/experiments/population_threshold_study.py`
...
- Temporal stability of rho across GW blocks at each threshold (uses `studies/kernels/stability.py`)
