...
4. **Gaps 9 and 10 (block boundaries + enforcement)** — address together when running stability analysis on full 2025-26 data (`temporal/signal_stability.ipynb`)
