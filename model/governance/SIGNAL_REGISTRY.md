...
**LENS-MARKET complete: 2026-05-22** — transfers_in and ownership_count informative DEF+MID; purchase_price informative DEF+FWD (FWD removed post-Phase 9 holdout reversal — see ENG-02)
...
| MARKET-004 | purchase_price | MARKET | lag-1 | GKP (uninformative), DEF (informative), MID (uninformative), FWD (excluded-holdout-reversal) | flagged | conditional | DEF: approved-secondary (G-SYNTH1-06, w=0.50). FWD: REMOVED — Phase 9 holdout rho=−0.095 (p=0.374); removed from scoring pending SYNTH-02 (ENG-02). | DEF: rho 0.121, CI [0.082, 0.162], passes 2/3 blocks, decision relevant. FWD: SYNTH-01 in-sample rho=0.155 (G3-WEAK, 2/3 blocks). Phase 9 GW 34-38 holdout: rho=−0.095 (p=0.374, n=89) — non-significant reversal. Season-end rotation explanation: expensive FWDs rested after position targets secured. Removed from FWD scoring; lifecycle_state=excluded, downstream_status=blocked. SYNTH-02 required for phase-conditional evaluation. GKP: CI excludes zero but non-monotonic. MID: CI excludes zero (rho 0.121) but non-monotonic (Q5-Q1=1.37 but monotonic=False). SYNTH-01 DEF: partial rho=0.0550 controlling for transfers_in+ownership_count; G3-WEAK caveat resolved. | 2026-05-27 / ENG-02 2026-05-31 |
