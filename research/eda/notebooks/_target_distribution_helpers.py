...
Computation lives in analytics.target.distribution.
This module re-exports those symbols for notebook compatibility and owns
visualization helpers (plot functions require matplotlib, belong in notebook layer).
"""
...
from core.target.distribution import (
    analyze_by_group,
    analyze_data_completeness,
    analyze_dgw_vs_sgw,
    analyze_tail_frequency,
    compare_cohorts,
    compare_dgw_vs_sgw_across_cohorts,
    compare_tail_frequency_across_cohorts,
    compute_distribution_stats,
)

__all__ = [
    # computation (re-exported)
    "analyze_by_group",
    "analyze_data_completeness",
    "analyze_dgw_vs_sgw",
    "analyze_tail_frequency",
    ...
    "compare_tail_frequency_across_cohorts",
    "compute_distribution_stats",
    # visualization (owned here)
    "plot_cohort_distributions",
    "plot_gw_blocks_by_cohort",
    "plot_position_distributions_by_cohort",
]


# ---------------------------------------------------------------------------
# Visualization helpers — owned here, not extracted (matplotlib / display layer)
# ---------------------------------------------------------------------------
