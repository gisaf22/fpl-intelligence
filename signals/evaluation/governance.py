...
from signals.lifecycle.schema import GovernanceMetadata, GovernanceMetadataError

_EVAL_METADATA_PATH = Path("signals/evaluation/evaluation_metadata.yaml")
...
def get_signal_governance(signal: str, position: str) -> GovernanceMetadata:
    ...
    if not matches:
        raise GovernanceMetadataError(
            ...
            "Add an entry to signals/evaluation/evaluation_metadata.yaml."
        )
