"""Signal-target relationship geometry helpers — study-layer copy.

Analytical computation used by EDA notebooks and experiment studies.
Schema constants inlined; no signals.* imports.
"""
