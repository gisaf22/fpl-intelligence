...
def minimal_spine_df() -> pd.DataFrame:
    ...
    """
    rows = [
        {"player_id": 1, "gw": 1, "is_bgw": False, "is_dgw": False,
         "minutes": 90.0, "xgi": 0.4, "xgc": 0.2, "clean_sheets": 1.0, "goals_conceded": 0.0,
         "position_code": 3},
        {"player_id": 1, "gw": 2, "is_bgw": False, "is_dgw": False,
         "minutes": 60.0, "xgi": 0.1, "xgc": 0.5, "clean_sheets": 0.0, "goals_conceded": 1.0,
         "position_code": 3},
        {"player_id": 1, "gw": 3, "is_bgw": False, "is_dgw": False,
         "minutes": 90.0, "xgi": 0.6, "xgc": 0.1, "clean_sheets": 1.0, "goals_conceded": 0.0,
         "position_code": 3},
        {"player_id": 2, "gw": 1, "is_bgw": False, "is_dgw": False,
         "minutes": 90.0, "xgi": 0.2, "xgc": 0.3, "clean_sheets": 0.0, "goals_conceded": 2.0,
         "position_code": 2},
        {"player_id": 2, "gw": 2, "is_bgw": False, "is_dgw": False,
         "minutes": 0.0,  "xgi": 0.0, "xgc": 0.4, "clean_sheets": 0.0, "goals_conceded": 1.0,
         "position_code": 2},
        {"player_id": 2, "gw": 3, "is_bgw": False, "is_dgw": False,
         "minutes": 45.0, "xgi": 0.3, "xgc": 0.2, "clean_sheets": 1.0, "goals_conceded": 0.0,
         "position_code": 2},
    ]
