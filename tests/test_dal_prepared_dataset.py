            ...
            rows.append(
                {
                    ...
                    "penalties_saved": None if is_bgw else 0,
                    "penalties_missed": None if is_bgw else 0,
                    "own_goals": None if is_bgw else 0,
                    "tackles": None if is_bgw else 0,
                    "recoveries": None if is_bgw else 0,
                    "clearances_blocks_interceptions": None if is_bgw else 0,
                    "defensive_contribution": None if is_bgw else 0,
